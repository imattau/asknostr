...
export type ViewType = 'feed' | 'thread' | 'relays' | 'mediaservers' | 'profile' | 'communities' | 'community' | 'modqueue' | 'modlog' | 'createcommunity' | 'communityadmin' | 'search' | 'claimstation' | 'sidebar' | 'connectbunker'
