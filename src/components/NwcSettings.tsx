    ...
    <div className="p-6 space-y-8 pb-20">
      ...
      {nwcUrl ? (
        <div className="space-y-6">
          <div className="p-6 glassmorphism border-emerald-500/20 bg-emerald-500/5 rounded-2xl flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-500 shrink-0">
              <CheckCircle size={24} />
            </div>
            <div>
              <h3 className="font-bold text-slate-50 uppercase text-sm tracking-tight">Active_Authorization</h3>
              <p className="text-[10px] text-emerald-500 font-mono uppercase mt-0.5">Secure Tunnel established</p>
            </div>
          </div>

          <div className="p-4 bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden">
            <p className="text-[8px] font-mono text-slate-600 uppercase tracking-widest mb-2 px-1">Node_ID_Mask</p>
            <p className="text-[10px] font-mono text-slate-400 truncate opacity-50 px-1">{nwcUrl}</p>
          </div>
        ...
        <div className="space-y-6">
          <div className="p-4 glassmorphism border-amber-500/20 rounded-xl flex items-start gap-3">
            <Info size={18} className="text-amber-500 shrink-0 mt-0.5" />
            <p className="text-[10px] leading-relaxed text-slate-400 uppercase font-mono">
          ...
          <div className="pt-8 opacity-20 text-center">
            ...
            <p className="text-[9px] font-mono uppercase tracking-[0.3em]">Status: Disconnected</p>
          </div>
        </div>
      )}
    </div>
